...
(function () {
  ...
  var db = {
    ...
    exp_rules: [
      ...
      { field: 'whatsapp',         points: 10, label: 'WhatsApp',         hint: 'For your manager to reach you quickly',        min_length: 1,  sort_order: 60 },
        ...
        invoke: function (name, opts) {
          return delay(700).then(function () {
            ...
            db.profiles.push({
              ...
              city: b.city || null,
              phone: null, whatsapp: null, avatar_url: null,
              address: null, website: null, social_facebook: null,
              social_instagram: null, social_telegram: null, about: null, logo_url: null,
